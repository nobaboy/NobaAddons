...
object MayorAPI {
	...
	private val MAYOR_NAME_REGEX by Repo.regex("mayor.name", "Mayor (?<name>[A-z]+)")
	private val ELECTION_END_MESSAGE by Repo.string("mayor.election_end", "The election room is now closed. Clerk Seraphine is doing a final count of the votes...")

	val FOXY_EVENT_REGEX by Repo.regex("mayor.foxy_event", "Schedules an extra §.(?<event>[A-z ]+) §.event during the year\\.")
