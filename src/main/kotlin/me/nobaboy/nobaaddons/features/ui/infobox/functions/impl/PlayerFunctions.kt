...
object PlayerFunctions {
	...
	object BpsFunction : InfoBoxFunction<Double?> {
		...
		override fun execute(): Double? {
			...
			val dX = player.x - player./*? if >=1.21.5-pre2 {*/lastX/*?} else {*//*prevX*//*?}*/
			val dY = player.y - player./*? if >=1.21.5-pre2 {*/lastY/*?} else {*//*prevY*//*?}*/
			val dZ = player.z - player./*? if >=1.21.5-pre2 {*/lastZ/*?} else {*//*prevZ*//*?}*/
